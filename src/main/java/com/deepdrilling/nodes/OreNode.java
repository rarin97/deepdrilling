...
public class OreNode {
    public static OreNode EMPTY = new OreNode(DeepDrilling.asResource("empty"), "", "", "", WeightMultipliers.ZERO);
    ...
    public LootTable getTable(ServerLevel level, LOOT_TYPE type) {
        return level.getServer()
                ...
                .getLootTable(ResourceKey.create(Registries.LOOT_TABLE, OreNodes.parseId(getTableName(type))));
    }
