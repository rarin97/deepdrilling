...
public class    DPartialModels {
    ...
    public static PartialModel block(String path) {
        ...
        return PartialModel.of(DeepDrilling.asResource("block/" + path));
    }
    ...
    public static boolean init() {
        DeepDrilling.LOGGER.info("Loading partial models for {} drill heads", DDrillHeads.knownDrillHeads.size());
